# -*- coding: utf-8 -*-
"""
These util functions were copied from the official
SpikeGLX_Datafile_Tools, accesed here on 2022-11-21:
https://billkarsh.github.io/SpikeGLX/#post-processing-tools

A copy of the original python code is included in this repo at
Python/SpikeGLX_Datafile_Tools/DemoReadSGLXData/readSGLX.py 

I copy-pasted them here so I could manage my own modules, and
because I wanted to omit the dependencies for interactive GUI
and plotting.
"""
import numpy as np
